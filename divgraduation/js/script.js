    ...
    const wrapBox = document.getElementById("wrapBox") //== обертка боксов
...
//=====вспомогательные функции
    ...
    function boxChangeCoor(tapBoxSide) {
        for (let i = 0; i< tapBoxSide.length; i++) {
            ...
            tapBoxSide[i].style.top = +tapBoxSide[i].style.top.split("px").join("") +1 +"px";
            // tapBoxSide[i].style.transform = `translateY(${yPos}px)`;
